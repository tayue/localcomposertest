...
$hashServer->addServer('192.168.99.88:6379');
$hashServer->addServer('192.168.99.88:6380');
$hashServer->addServer('192.168.99.88:6381');

echo "增加3台服务器192.168.1.1~192.168.1.10<br />";
...
echo '<hr />';
echo "移除一台服务器192.168.99.88:6379<br />";
$hashServer->removeServer('192.168.99.88:6379');
echo "保存 key1 到 server :".$hashServer->lookup('key1') . '<br />';
echo "保存 key2 到 server :".$hashServer->lookup('key2') . '<br />';
echo "保存 key3 到 server :".$hashServer->lookup('key3') . '<br />';
echo "保存 key4 到 server :".$hashServer->lookup('key4') . '<br />';
