...
class ModelCommand extends Command
{
    protected function configure()
    {
        $this
            ...
            ->setDescription('Create new person')
            ...
            ->addArgument('age', InputArgument::REQUIRED, 'what\'s age you want to create ?')
            // 配置一个可选参数
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln('created name:' . $input->getArgument('name') . ', age:'.$input->getArgument('age').' success !');
